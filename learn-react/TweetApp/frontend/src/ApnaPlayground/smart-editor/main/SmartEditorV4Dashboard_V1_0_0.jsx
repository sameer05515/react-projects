...
import { SmartEditor as SmartEditorV3, SmartPreviewer as SmartPreviewerV3 } from "../../../common/components/Smart/Editor/v3";
  ...
  return (
    <div>
      <div>
        ...
        <ToggleablePanel showContent={true} title="observations">
          <SmartPreviewerV3 data={{ content: observations, textOutputType: "text" }} />
        </ToggleablePanel>
