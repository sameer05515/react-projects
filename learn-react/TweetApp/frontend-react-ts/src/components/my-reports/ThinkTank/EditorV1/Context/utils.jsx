...
export const PurposeToOpenModal = {
  ...
  Open_Show_Statistics: "open-show-statistics",
  ...
  UPDATE_OPEN_OR_CLOSED_STATUS_OF_EXISTING_TTITEM_WITH_REASON:
    "update-open-or-closed-status-of-existing-tt-item-with-reason",
  UPDATE_IMPORTANT_OR_NOT_IMPORTANT_FLAG_OF_EXISTING_TTITEM_WITH_REASON:
    "update-important-or-not-important-flag-of-existing-tt-item-with-reason",
  UPDATE_URGENT_OR_NOT_URGENT_FLAG_OF_EXISTING_TTITEM_WITH_REASON:
    "update-urgent-or-not-urgent-flag-of-existing-tt-item-with-reason",
};
