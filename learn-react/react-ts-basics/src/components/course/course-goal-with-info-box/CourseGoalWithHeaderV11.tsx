...
const CourseGoalWithHeaderV11 = () => {
  ...
  return (
    <main>
      ...
      <CourseGoalListV3 goals={goals} onDeleteGoal={handleDeleteGoal} />
    </main>
  );
};

export default CourseGoalWithHeaderV11;
