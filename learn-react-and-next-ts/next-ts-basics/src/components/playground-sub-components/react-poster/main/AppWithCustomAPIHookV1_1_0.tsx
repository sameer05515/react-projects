...
import { useApiRequest } from "@/common/hooks/api-requests/useApiRequestV7"; // Path where hook is saved
...
const AppWithCustomAPIHookV1_1_0 = () => {
  const {
  ...
  return (
    <div className={`${main}`}>
      <h1>AppWithCustomAPIHookV1_1_0</h1>
      ...
      <JSONDataViewer
        metadata={{ result }}
        title="AppWithCustomAPIHookV1_1_0: Data X-ray"
      />
...
export default AppWithCustomAPIHookV1_1_0;
