...
import { useApiRequest } from "@/common/hooks/api-requests/useApiRequestV4"; // Path where hook is saved

const BaseURL = "http://127.0.0.1:3003/tweets/v2";

const AppWithCustomAPIHookV1_0_7 = () => {
  ...
  return (
    <div>
      <h1>AppWithCustomAPIHookV1_0_7</h1>
...
export default AppWithCustomAPIHookV1_0_7;
