...
const AppContainerComponent = () => {
    const { levelCompArr } = useSharedConfigurations();
    return <ContainerComponent levelCompArr={levelCompArr} />;
}

export default ReactArcherApp12;
