...
// Main Component
const ReactArcherApp8 = ({ data = getUpdatedArrayForType(ArrayType.britishRoyalFamily) }) => {
    ...
    const renderTree = (nodes, level = 0, parentId = '') => {
        ...
        return (
            <>
                <TreeLevel nodes={nodes} level={level} parentId={parentId} />
