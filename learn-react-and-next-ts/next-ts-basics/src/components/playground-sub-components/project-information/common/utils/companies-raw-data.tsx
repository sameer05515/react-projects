export const companiesRawData = [
    {
      __typename: "Company",
      uniqueId: "cad35406-3caf-42a6-a886-960c6c725371",
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          references: ["Pankaj Kumar, Admin"],
        },
      },
      projects: [
        {
          __typename: "Project",
          uniqueId: "1eafcf2a-1540-4059-97de-9f7985d183c2",
          name: "OSCART",
          details:
    ...
    },
    {
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          officeAddress: "Noida",
          employmentType: "Contractual",
          aboutCompany: ["Company is good.", "They renew contarcts on time."],
          ...
          lastReasonForChange: {
            actual:
              "A better opportunity to learn and earn was available to me. Additionally, I received a permanent job offer that I found very promising upon joining. I also had plans to settle in Faridabad, as it is equidistant from Gurgaon, Noida, and Delhi.",
            forHR: "better opportunity to learn and earn",
          },
          projects: ["CIPA/ CIPRUS"],
          techStack: [
            "Java with JDBC, JasperReports for backend development",
            "Junit to write unit cases",
            "ANT to build project artifacts",
          ...
          employmentHistories: [
            {
              ...
              designation: "DEVELOPER",
              reasonForJoining:
                "HCLI is good name in market. I joined here for better growth and opportunity to better learn and earn.",
              reasonForChange: [
                {
                  actual:
                    "A better opportunity to learn and earn was available to me. Additionally, I received a permanent job offer that I found very promising upon joining. I also had plans to settle in Faridabad, as it is equidistant from Gurgaon, Noida, and Delhi..",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "5e8a0cd0-2b11-4a73-9bb3-4d5a4d71a8a6",
          name: "CIPRUS",
          details:
          ...
          processedDetails: {
            ...
            metadata: {
              ...
              techStack: ["Core Java", "Swing", "JDBC", "JasperReports"],
              rolesAndResponsibilities: [
                {
                  role: "Developer",
                  responsibilities: [
    ...
    },
    {
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          officeAddress: "Faridabad",
          employmentType: "Permanent",
          aboutCompany: ["Company is good.", "This is start-up company."],
          domainOfCompany: [
            "Product-based",
            "Telecom Software Domain",
            "Company was developing software solutions With Cisco API",
          ...
          lastReasonForChange: {
            actual:
              "At the time of joining I assumed that the company would send me to an Abroad site, but this did not occur. Also, no satisfactory hike was received.",
            forHR: "better opportunity to learn and earn.",
          },
          projects: ["iAgent 4.0", "Survey", "KnowlegeBase"],
          techStack: [
            "Java, J2ee, JDBC, Apache Solr, Hibernate, Jersey for backend development",
            "Junit to write unit cases",
            "ANT to build project artifacts",
          ...
          employmentHistories: [
            {
              ...
              designation: "APPLICATION DEVELOPER",
              reasonForJoining:
                "I received a permanent job offer that I found very promising upon joining. I also had plans to settle in Faridabad, as it is equidistant from Gurgaon, Noida, and Delhi.",
              reasonForChange: [
                {
                  actual:
                    "At the time of joining I assumed that the company would send me to an Abroad site, but this did not occur. Also, no satisfactory hike was received.",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "94c60456-778f-420a-84e2-a1175a70d3ce",
          name: "iAgent 4.0",
          details:
            "project: iAgent 4.0\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "c1cbf56a-4ea5-4c61-bfd2-ccbcd3a29477",
          name: "Survey",
          details:
            "project: Survey\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "763c4dc1-242d-468d-a1fc-62ad7f9f3e65",
          name: "KnowledgeBase",
          details:
    ...
    {
      __typename: "Company",
      uniqueId: "ed945b8a-97a6-4e7a-9893-c5aa5aa39448",
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          officeAddress: "Gurgaon",
          employmentType: "Permanent",
          aboutCompany: ["Company is good.", "I learnt a lot while work here"],
          ...
          employmentHistories: [
            {
              ...
              reasonForChange: [
                {
                  actual:
                    "Internal switch for contractual to permanent position in Concentrix.",
                  forHR:
                    "Internal switch for contractual to permanent position in Concentrix.",
                },
              ],
            ...
            },
            {
              ...
              designation: "ASSISTANT MANAGER, IT APPLICATIONS",
              reasonForJoining:
                "Due to resignation from Accenture due to location issue, I re-joined Concentrix.",
              reasonForChange: [
                {
                  actual: "Better opportunity from Dhani stocks.",
                  forHR: "better opportunity to learn and earn.",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "70d3433d-f214-4a4e-9d87-3de7f8674936",
          name: "QAA",
          details:
            "project: QAA\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "2a9dca4c-cec1-44ef-bc47-27f6ef418d81",
          name: "Webdots",
          details:
            "project: Webdots\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "2aadfdf6-cc50-4c16-b331-07100fd3c942",
          name: "Econvey",
          details:
            "project: Econvey\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "40f29195-02f4-4626-a30e-420ba04abc37",
          name: "Zetta",
          details:
            "project: Zetta\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "638263f5-545b-4a38-bd8d-4624be57cf20",
          name: "ResolveJiffy",
          details:
            "project: ResolveJiffy\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
            __typename: "ProcessedDetails",
            rawText:
              "project: ResolveJiffy\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
        ...
        {
          __typename: "Project",
          uniqueId: "e4b74d25-0e9d-4982-8ffb-f87884729bd6",
          name: "UnI",
          details:
            "project: UnI\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "65adfdc9-2bbd-4e9e-96a1-9e09adf12239",
          name: "Gain Manager",
          details:
            "project: Gain Manager\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
            __typename: "ProcessedDetails",
            rawText:
              "project: Gain Manager\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
        ...
        {
          __typename: "Project",
          uniqueId: "e4a00e29-daed-4e11-87e5-c6be2560053e",
          name: "GIP",
          details:
            "project: GIP\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
    ...
    },
    {
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          lastReasonForChange: {
            actual:
              "Due to location issues, I felt ill and came back to home at Faridabad.",
            forHR:
              "Due to location issues, I felt ill and came back to home at Faridabad.",
          },
          projects: ["ZVR4 Data Migration"],
          techStack: [
            "Java with Spring Boot, Spring Batch, Spring REST, Multithreading for backend development",
            "Junit to write unit cases",
            "Maven to build project artifacts and dependency management",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "bfef2703-7f6b-447b-8fd2-86feb43248c5",
          name: "ZVR4",
          details:
            "project: ZVR4\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
    ...
    },
    {
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          order: 5,
          aboutCompany: ["comapny is good", "However, No good hike."],
          domainOfCompany: [
            "Product based company",
            "Finance domain company",
            "Main application is for Share market trading",
          ...
          employmentHistories: [
            {
              ...
              reasonForChange: [
                {
                  actual:
                    "Better opportunity to learn and earn. Also due to late in revised offer letter with requested hike.",
                  forHR: "Better opportunity to learn and earn.",
                },
              ],
              joiningCTC: "8.25 LPA",
            ...
            },
            {
              ...
              designation: "TECHNICAL LEAD",
              reasonForJoining:
                "No quality work assigned in last comapny (Mynd Integrated Solutions Ltd, Gurgaon, India). Also Dhani Stocks offered me with promotion as Team Lead.",
              reasonForChange: [
                {
                  actual:
                    "Better opportunity to learn and earn. Also good hike (23 LPA) from RSystems.",
                  forHR: "Better opportunity to learn and earn",
                },
              ],
              joiningCTC: "10.5 LPA",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "2fc7393c-7f7a-4d73-8619-2731edbac78c",
          name: "ShubhWeb",
          details:
            "project: ShubhWeb\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "8a289656-8637-4dcc-97cd-7ec6b95833eb",
          name: "Notis API",
          details:
            "project: Notis API\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
        ...
        {
          __typename: "Project",
          uniqueId: "26787a0e-5d6f-45fd-8085-cb849c532de8",
          name: "JasperReports",
          details:
        ...
        {
          __typename: "Project",
          uniqueId: "8dcb67e2-bbad-4a8b-a1a8-4729a88970ac",
          name: "KRA",
          details: "",
          processedDetails: {
            __typename: "ProcessedDetails",
        ...
        {
          __typename: "Project",
          uniqueId: "60664c3d-6d2b-4960-8b8d-ee4d091e818e",
          name: "SFTP",
          details: "",
          processedDetails: {
            __typename: "ProcessedDetails",
    ...
    },
    {
      ...
      processedDetails: {
        ...
        metadata: {
          company: "Mynd Integrated Solutions Ltd, Gurgaon, India",
          order: 6,
          aboutCompany: ["comapny is good", "However, Internal politics felt."],
          ...
          lastReasonForChange: {
            ...
            forHR:
              "No quality work assigned. Also my last company(Dhani Stocks) offered me with promotion as Team Lead.",
          },
          projects: ["m1xchange"],
          techStack: [
            "Java with Spring Boot, Spring Batch, Spring REST, Multithreading for backend development",
          ...
          employmentHistories: [
            {
              ...
              designation: "SENIOR SOFTWARE DEVELOPER",
              reasonForJoining:
                "Better hike recieved on joining. Also, my updated offer letter with requested hike is recieved some late from last comapny(Dhani Stocks)",
              reasonForChange: [
                {
                  actual:
                    "Felt there was internal politics there. Reporting manager never agreed to communicate. Wrong stack work was assigned. I am from java background, but TL was forcing to work on Oracle PL/SQL programming. I felt difficulty in assigned task and asked several times my reporting manager to talk, but he never responded.",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "c6d19854-9e41-45b9-8d51-e6ada2f9c07f",
          name: "TReDS",
          details:
            "project: TReDS\ntenure: Mar 2011 to Apr 2012\ndescription: \n - The Common Integrated Police Application (CIPA) is a multilingual application to automate the processes (workflow) at primary sources of data itself e.g. Police Station and to build a crime & criminal Information system based on CrPC. It provides an efficient way of organizing crime records for generating queries/reports and crime analysis for decision support.\n - This is desktop application and can be installed in every police station.\n - Once all report logged into system, various reports can be generated from same application..\ntechStack: \n - Core Java\n - Swing\n - JDBC\n - JasperReports\nrolesAndResponsibilities:\n - role: Developer\n   responsibilities:\n    - Added code for new requirements to create views in Swing and attach it with Backend DAO layer to save/retrieve data\n    - Created methods in DAO persisten layer to save and retrieve data from database",
          processedDetails: {
    ...
    {
      __typename: "Company",
      uniqueId: "a754c952-9643-42b9-afa3-4c28c9ef4b7e",
      ...
      processedDetails: {
        ...
        metadata: {
          company: "RSystems International Pvt Ltd, Noida, India",
          order: 7,
          aboutCompany: ["company is good", "gives much hike"],
          ...
          lastReasonForChange: {
            actual:
              "Better hike recieved. Also it was roumor that Ephesoft will be shut down soon.",
            forHR: "Better hike.",
          },
          projects: ["Ephesoft Transact"],
          techStack: [
            "Java with Spring Boot, Spring Batch, Spring REST, Multithreading for backend development",
            "Junit to write unit cases",
            "Maven to build project artifacts and dependency management",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "72fe07f3-ad91-4ea4-93af-ad015ed6372c",
    ...
    },
    {
          ...
          employmentHistories: [
            {
              ...
              designation: "SENIOR BACKEND DEVELOPER",
              reasonForJoining:
                "I was laid off from last company, EVC Ventures. Hence I was looking for new opportunity having CTC offer more than or equals my last drawn CTC at EVC Ventures.",
              reasonForChange: [
                {
                  actual: "lay off.",
                  forHR: "lay off.",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "68128013-ff63-4f6c-875f-199b14929cbb",
          name: "IITD Admin",
          details:
    ...
    {
      __typename: "Company",
      uniqueId: "8c0c03e4-1ac9-4b17-8c4d-9466e39f896e",
      ...
      processedDetails: {
        ...
        metadata: {
          ...
          officeAddress: "Bangalore",
          employmentType: "Permanent",
          aboutCompany: ["The company is good.", "I love to work here"],
          domainOfCompany: ["Product-based", "Procurement domain"],
          companyWebsiteURL: "https://www.zycus.com/",
          overAllTenure: "June 2023 to Feb 2024",
          overAllTenureWithDate: "07 June 2023 to 22 Feb 2024",
          lastCTC: "32.2 LPA",
          lastEmployeeCode: 5938,
          lastDesignation: "SENIOR STAFF ENGINEER",
          lastReasonForChange: {
            actual:
              "Due to confusion from HR. They interpreted my leave request due to ill health as my absconding. So they terminated myself from service. They did not pay my notice period recovery.",
            forHR: "Termination due to ill health.",
          },
          projects: ["ESG Lythouse"],
          techStack: [
            "Java/J2EE, Spring Boot, Spring GraphQL for backend development",
            "Junit to write unit cases",
            "Maven, NodeJS to build project artifacts and dependency management",
      ...
      projects: [
        {
          __typename: "Project",
          uniqueId: "088ee538-5c99-4fad-bd1c-828337ed8142",
          name: "ESG Lythouse",
          details:
