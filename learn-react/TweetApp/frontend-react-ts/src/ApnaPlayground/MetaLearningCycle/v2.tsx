    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="relative w-96 h-96">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 text-center">
          <div
            className="rounded-full bg-blue-600 text-white py-2 px-3 shadow-sm cursor-pointer w-1/4 hover:bg-blue-700 transition-colors"
        ...
        <div className="absolute top-1/2 right-0 -translate-y-1/2 text-center mr-5">
          <div
            className="rounded-full bg-green-600 text-white py-2 px-3 shadow-sm cursor-pointer w-1/4 hover:bg-green-700 transition-colors"
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-center">
          <div
            className="rounded-full bg-yellow-600 text-white py-2 px-3 shadow-sm cursor-pointer w-1/4 hover:bg-yellow-700 transition-colors"
        ...
        <div className="absolute top-1/2 left-0 -translate-y-1/2 text-center ml-5">
          <div
            className="rounded-full bg-red-600 text-white py-2 px-3 shadow-sm cursor-pointer w-1/4 hover:bg-red-700 transition-colors"
