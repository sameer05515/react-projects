...
| [reactjs-storybook](../reactjs-storybook/)                                                                     | `reactjs-storybook/`                                  | React + Vite + Storybook | **Component library** (`npm run build` → `dist/`); Storybook + [docs/](../reactjs-storybook/docs/README.md). |
...
| [react-inner-scroll](../react-inner-scroll/)                             | `react-inner-scroll/`               | CRA (older) | Inner scroll demo; loads sample posts from JSONPlaceholder. [README](../react-inner-scroll/README.md) |
