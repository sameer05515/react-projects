...
import FlipExampleV2 from "./animation/FlipExampleV2";
import FlipExampleV3 from "./animation/FlipExampleV3";
import KeyframeAnimationDemo from "./animation/KeyframeAnimationDemo";
import ParallaxScroll from "./animation/ParallaxScroll";
import SpinExample from "./animation/SpinExample";
import TwoNodeComponent from "./arrow-react-archer-examples/TwoNodeComponent";
import TwoNodeComponentV2 from "./arrow-react-archer-examples/TwoNodeComponentV2";
import TwoNodeComponentV3 from "./arrow-react-archer-examples/TwoNodeComponentV3";
import TwoNodeComponentV4 from "./arrow-react-archer-examples/TwoNodeComponentV4";
import TwoNodeComponentV5 from "./arrow-react-archer-examples/TwoNodeComponentV5";
import TwoNodeComponentV5_1 from "./arrow-react-archer-examples/TwoNodeComponentV5.1";
import TwoNodeComponentV5_2 from "./arrow-react-archer-examples/TwoNodeComponentV5.2";
...
import LanguageSelectorV2_1 from "./display-prev-selected-and-next-nodes/LanguageSelectorV2_1";
import LanguageSelectorV2_1_1 from "./display-prev-selected-and-next-nodes/LanguageSelectorV2_1_1";
import LanguageSelectorV2_1_2 from "./display-prev-selected-and-next-nodes/LanguageSelectorV2_1_2";
import LanguageSelectorV2_1_2_1 from "./display-prev-selected-and-next-nodes/LanguageSelectorV2_1_2_1";
import LanguageSelectorV3 from "./display-prev-selected-and-next-nodes/LanguageSelectorV3";
import MonthList from "./dnd-playground/MonthList";
import TreeList from "./dnd-playground/TreeList";
import TreeListV2 from "./dnd-playground/TreeListV2";
...
const componentMapWithPurposes = {
  ...
  UseNavigationExampleComponentV2: {
    element: UseNavigationExampleComponentV2,
    purpose: "Optimized centralized routing, with carousel",
  },
  MonthList: {
    element: MonthList,
...
const getLabelForKey = (key) => {
  ...
  return key && compu
    ? `${key} - {${compu.module || ComponentModules.TestingPurpose}, ${
...
export const getComponentDetails = (key) => {
